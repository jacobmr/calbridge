...
**Secondary:** Small teams who need a shared calendar layer without migrating everyone to one platform.

---

## Value Propositions

1. **Universal Sync** — Google Calendar, Microsoft Outlook, and ICS feeds. Not "eventually." Now.
2. **Sync Flows** — Define rules: "Copy my personal Google events to my work Outlook, but only 9-5, and mark them private."
3. **Public Booking Pages** — Share a link. Let people book. No account required for attendees.
4. **Multi-Tenant Workspaces** — One account, multiple workspaces. Perfect for agencies managing client calendars.
5. **Privacy-First** — Your tokens are encrypted at rest with AES-256-GCM. We can't read your calendar data.

---

## Tone of Voice

- **Clear over clever.** Say what it does. No jargon.
- **Confident, not arrogant.** We solve a real problem. We don't need to oversell.
- **Helpful.** Like a colleague who actually knows how to fix your calendar mess.
- **Modern but trustworthy.** Not "startup-bro." Not "enterprise-boring."

**Do:** "Sync your Google and Outlook calendars in under 2 minutes."
**Don't:** "Leverage our best-in-class calendaring synergies to maximize your temporal ROI."
...
- Text: `#1A202C` (Charcoal) — readability, sophistication
...
- Micro-interactions on CTAs — responsiveness matters
...
1. **Primary:** "Connect Your First Calendar" (action-oriented, low friction)
2. **Secondary:** "See How Sync Works" (education for browsers)
3. **Tertiary:** "View Pricing" (for comparison shoppers)
